...
export default function Home() {
  return (
    <div className="grid grid-rows-[20px_1fr_auto] items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20 font-[family-name:var(--font-geist-sans)]">
      ...
      <footer className="row-start-3 flex gap-6 flex-wrap items-center justify-center flex-col">
        <div className="w-full max-w-[728px] min-h-[90px] mb-8">
          {process.env.NEXT_PUBLIC_ADSENSE_CLIENT_ID && (
            <AdSense
              client={process.env.NEXT_PUBLIC_ADSENSE_CLIENT_ID}
              slot="YOUR_AD_UNIT_ID"
